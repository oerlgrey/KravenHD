...
class KravenHDCaidInfo2(Poll, Converter, object):
	CAID = 0
	PID = 1
	PROV = 2
	ALL = 3
							...
							for param in params:
								if param != '':
									...
									#prov
										...
										textvalue+="ProvId: " + prov
									#sOurce
									elif param == "%O":
										textvalue+=source
									#Reader
									elif param == "%R":
										textvalue+="Reader: " + reader
									#ECM Time
									elif param == "%T":
										textvalue+="ECM: " + ecm_time
									elif param == "%t":
										textvalue+="\t"
									elif param == "%n":
										textvalue+="\n"
